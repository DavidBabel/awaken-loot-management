...
describe('authorization middleware helpers', () => {
  it('should detect correctly a queries', () => {
    ...
    expect(isQuery(QUERY_MERITES)).toBe(true);
    expect(isQuery(QUERY_PLAYERMERITES)).toBe(true);
    ...
    expect(isQuery(MUTATION_MERITE)).toBe(false);
    expect(isQuery(MUTATION_PLAYER)).toBe(false);
    expect(isQuery(MUTATION_PLAYERMERITE)).toBe(false);
  ...
  it('should detect correctly a mutations', () => {
    ...
    expect(isMutation(QUERY_MERITES)).toBe(false);
    expect(isMutation(QUERY_PLAYERMERITES)).toBe(false);
    ...
    expect(isMutation(MUTATION_MERITE)).toBe(true);
    expect(isMutation(MUTATION_PLAYER)).toBe(true);
    expect(isMutation(MUTATION_PLAYERMERITE)).toBe(true);
  ...
  it('should retreive correctly all found mutations', () => {
    ...
    expect(getMutation(QUERY_MERITES)).toEqual([]);
    expect(getMutation(QUERY_PLAYERMERITES)).toEqual([]);
    ...
    expect(getMutation(MUTATION_MERITE)).toEqual(['createMerite']);
    expect(getMutation(MUTATION_PLAYER)).toEqual(['createPlayer']);
    expect(getMutation(MUTATION_PLAYERMERITE)).toEqual(['createPlayerMerite']);
...
describe('exposed rights', () => {
  it('should manage admin rights correctly', () => {
    ...
    expect(checkRights('admin', QUERY_MERITES)).toBe(true);
    expect(checkRights('admin', QUERY_PLAYERMERITES)).toBe(true);
    ...
    expect(checkRights('admin', MUTATION_MERITE)).toBe(true);
    expect(checkRights('admin', MUTATION_PLAYER)).toBe(true);
    expect(checkRights('admin', MUTATION_PLAYERMERITE)).toBe(true);
  ...
  it('should manage officer rights correctly', () => {
    ...
    expect(checkRights('officer', QUERY_MERITES)).toBe(true);
    expect(checkRights('officer', QUERY_PLAYERMERITES)).toBe(true);
    ...
    expect(checkRights('officer', MUTATION_MERITE)).toBe(false);
    expect(checkRights('officer', MUTATION_PLAYER)).toBe(false);
    expect(checkRights('officer', MUTATION_PLAYERMERITE)).toBe(true);
  ...
  it('should manage classMaster rights correctly', () => {
    ...
    expect(checkRights('classMaster', QUERY_MERITES)).toBe(true);
    expect(checkRights('classMaster', QUERY_PLAYERMERITES)).toBe(true);
    ...
    expect(checkRights('classMaster', MUTATION_MERITE)).toBe(false);
    expect(checkRights('classMaster', MUTATION_PLAYER)).toBe(false);
    expect(checkRights('classMaster', MUTATION_PLAYERMERITE)).toBe(true);
  ...
  it('should manage player rights correctly', () => {
    ...
    expect(checkRights('player', QUERY_MERITES)).toBe(true);
    expect(checkRights('player', QUERY_PLAYERMERITES)).toBe(true);
    ...
    expect(checkRights('player', MUTATION_MERITE)).toBe(false);
    expect(checkRights('player', MUTATION_PLAYER)).toBe(false);
    expect(checkRights('player', MUTATION_PLAYERMERITE)).toBe(false);
  ...
  it('should manage guest rights correctly', () => {
    ...
    expect(checkRights('guest', QUERY_MERITES)).toBe(false);
    expect(checkRights('guest', QUERY_PLAYERMERITES)).toBe(false);
    ...
    expect(checkRights('guest', MUTATION_MERITE)).toBe(false);
    expect(checkRights('guest', MUTATION_PLAYER)).toBe(false);
    expect(checkRights('guest', MUTATION_PLAYERMERITE)).toBe(false);
