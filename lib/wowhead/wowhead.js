...
if (typeof $WowheadPower === "undefined") {
  var $WowheadPower = new function() {
      ...
      var aB = {
          ...
          al, F, U, ay, p, aq, aw, av, ap = aG["float"],
          H = false,
          af = null,
          G = 1,
          E = 1,
      ...
      var ab = new function() {
          ...
          this.fetch = function(a5, a7) {
              ...
              a4 += "&json";
              WH.xhrJsonRequest(a4, (function(a8, ba, a9) {
                  if (!a9) {
                      WH.error("Wowhead tooltips failed to load scaling data for " + ax(a8));
                      return
                  }
                  ab.setData(a8, ba, a9)
              }).bind(null, a5, a7))
      ...
      function az() {
          ...
          for (var aY in aZ) {
              ...
              if (aP.insertRule) {
                  aP.insertRule(".wowhead-tooltip .whtt-" + aY + "{display: none}", aP.cssRules.length)
              } else {
                  if (aP.addRule) {
      ...
      function aU(aY) {
          if (typeof ad[aY] !== "object") {
              throw new Error("Wowhead tooltips could not find config for entity #" + aY)
          }
          return ad[aY].data
      }
      ...
      function J(a1, bm) {
          if (bm && a1.dataset && a1.dataset.simpleTooltip) {
              ...
              WH.Tooltip.show(a1, a1.dataset.simpleTooltip.length < 30 ? '<div class="no-wrap">' + a1.dataset.simpleTooltip + "</div>" : a1.dataset.simpleTooltip);
              return e
          }
          ...
          if ((!a1.href.length && !a5) || (a5 && /^np\b/.test(a5)) || (a1.getAttribute("data-disable-wowhead-tooltip") === "true") || (WH.isTouch() && a1.getAttribute("data-disable-wowhead-touch-tooltip") === "true")) {
              return o
          }
          var bj, bi, bh, aZ, bp = {};
          p = bp;
          ...
          if (aZ == null && a5 && (aB.applyto & 2)) {
              ...
              bi = 1;
              bh = 2;
              aZ = a5.match(/(item|quest|spell|zone|achievement|event|itemset|item-set|transmog-set|outfit|statistic|currency|npc|object|pet-ability|petability|building|follower|champion|bfa-champion|garrisonability|mission-ability|mission|ship|threat|resource|order-advancement|affix|azerite-essence|azerite-essence-power|guide).?(-?\d+(?:\.\d+)?)/);
              E = 1
          }
          if (!aZ) {
              return o
          ...
          if (bt !== null) {
              ...
              if ((new RegExp("\\b" + WH.BETA_DOMAIN + "\\b")).test(bt)) {
                  ...
                  for (var bc in WH.dataEnv) {
                      if (!WH.dataEnv.hasOwnProperty(bc) || !WH.dataEnvTerm.hasOwnProperty(WH.dataEnv[bc])) {
                          continue
                      }
                      if ((new RegExp("\\b" + WH.dataEnvTerm[WH.dataEnv[bc]] + "\\b")).test(bt)) {
                          aY = WH.dataEnv[bc];
                          break
                      }
                  }
          ...
          if (a1.href.indexOf("#") != -1 && document.location.href.indexOf(aZ[bi] + "=" + aZ[bh]) != -1) {
              return o
          }
          var a9 = false;
          if (WH.isTouch()) {
          ...
          if (a9) {
              ...
              if ((a1.parentNode.className.indexOf("icon") == 0 && a1.parentNode.nodeName == "DIV") || a1.getAttribute("data-whattach") == "icon") {
                  ap = aG.attachToIcon
              } else {
          ...
          if (bm) {
              ...
              if (typeof a1.overrideTooltip == "object") {
                  ...
                  if (a1.overrideTooltip.spanClass) {
                      bd = '<span class="' + a1.overrideTooltip.spanClass + '">' + bd + "</span>";
                      if (bb) {
                          bb = '<span class="' + a1.overrideTooltip.spanClass + '">' + bb + "</span>"
                      }
                  }
                  aT(bk, bd, a1.overrideTooltip.icon, a1.overrideTooltip.map, a1.overrideTooltip.spellData, bb, a1.overrideTooltip.image, a1.overrideTooltip.imageClass)
              } else {
                  h(a3, a2, aY, bk, bp)
              }
          }
          ...
          var bg = [];
          if ((j("renameLinks") && a1.getAttribute("data-wh-rename-link") !== "false") || a1.getAttribute("data-wh-rename-link") === "true") {
              bg.push(function() {
      ...
      function aE(aZ, a0, aY) {
          ...
          if (aY === "tiny") {
              ...
              aZ.style.background = "url(" + g_staticUrl + "/images/wow/icons/tiny/" + a1 + ".gif) left center no-repeat"
          } else {
              if (aZ.getAttribute("data-wh-icon-added") === "true") {
                  return
              }
              WH.aef(aZ, WH.Icon.create(a1, aY, null, {
                  span: true
              }))
          }
      ...
      function ak(a0) {
          ...
          if (document.location.port !== "") {
              aZ += ((document.location.port.indexOf(":") < 0) ? ":" : "") + document.location.port
          }
      ...
      function h(a3, aZ, a0, a5, a1) {
          ...
          if (a2.status === an || a2.status === g) {
              ...
              aT(a5, a2.data[w()], a2.data[aS()], a2.data.map, a2.data[aX()], a2.data[w(2)], a6, a7)
          } else {
      ...
      function aC(a8, aZ, a0, bb, a7, a1) {
          ...
          WH.xhrJsonRequest(ba, (function(bf, bi, be, bh, bd, bg) {
              if (!bg) {
                  WH.error("Wowhead tooltips failed to load data for " + ax(bf) + " #" + bi);
                  return
              } else {
                  if (bg.error) {
                      WH.error("Wowhead tooltip request responded with an error", bg.error, ax(bf) + " #" + bi)
                  }
              }
      ...
      function aT(bf, bi, a5, bh, aY, bp, a0, a4) {
          ...
          if (!bi) {
              ...
              if (p != null) {
                  if (WH.reforgeStats && p.forg && WH.reforgeStats[p.forg]) {
                      ...
                      var bt;
                      if ((bt = bi.match(new RegExp("(<!--(stat|rtg)(" + by.join("|") + ")-->)[+-]?([0-9]+)"))) && !bi.match(new RegExp("<!--(stat|rtg)" + a3.i2 + "-->[+-]?[0-9]+"))) {
                          var bq = Math.floor(bt[4] * a3.v),
                              bo = aQ.traits[a3.s2][0];
                          if (a3.i2 == 6) {
                              bi = bi.replace("<!--rs-->", "<br />+" + bq + " " + bo)
                          } else {
                              bi = bi.replace("<!--rr-->", WH.sprintfGlobal(aQ.tooltip_genericrating, bo.toLowerCase(), a3.i2, bq))
                          }
                          bi = bi.replace(bt[0], bt[1] + (bt[4] - bq));
                          bi = bi.replace("<!--rf-->", '<span class="q2">' + WH.sprintfGlobal(aQ.tooltip_reforged, bq, aQ.traits[a3.s1][2], aQ.traits[a3.s2][2]) + "</span><br />")
                      }
                  }
                  if (p.pcs && p.pcs.length) {
                      ...
                      for (var bv = 0, a9 = p.pcs.length; bv < a9; ++bv) {
                          var bt;
                          var be = new RegExp("<span><!--si([0-9]+:)*" + p.pcs[bv] + '(:[0-9]+)*--><a href="/??item=(\\d+)">(.+?)</a></span>');
                          if (bt = bi.match(be)) {
                              var bx = !isNaN(parseInt(ay)) ? s[ay] : "enus";
                              var a7 = (WH.isSet("g_items") && g_items[p.pcs[bv]]) ? g_items[p.pcs[bv]]["name_" + bx] : bt[4];
                              var a1 = '<a href="/item=' + bt[3] + '">' + a7 + "</a>";
                              var bd = '<span class="q13"><!--si' + p.pcs[bv] + "-->" + a1 + "</span>";
                      ...
                      if (bs > 0) {
                          bi = bi.replace("(0/", "(" + bs + "/");
                          bi = bi.replace(new RegExp("<span>\\(([0-" + bs + "])\\)", "g"), '<span class="q2">($1)')
                      }
                  }
                  ...
                  if (p.who && p.when) {
                      bi = bi.replace("<table><tr><td><br />", '<table><tr><td><br /><span class="q2">' + WH.sprintf(c(bf, "achievementComplete"), p.who, p.when.getMonth() + 1, p.when.getDate(), p.when.getFullYear()) + "</span><br /><br />");
                  ...
                  if ((al == Z) && p.cri) {
                      for (var bv = 0; bv < p.cri.length; bv++) {
                          bi = bi.replace(new RegExp("<!--cr" + parseInt(p.cri[bv]) + ":[^<]+", "g"), '<span class="q2">$&</span>')
                      }
                  }
              }
          }
          if (!P && WH.isSet("g_user") && ("lists" in g_user) && WH.isSet("g_completion") && WH.isRetailTree(U)) {
              var a2 = "";
              var aZ = ((al in g_types) && (g_types[al] in g_completion)) ? g_completion[g_types[al]] : false;
              var a8 = $WowheadPower.getEntity(al, F);
              if (aZ && (al == aI)) {
                  if (bl || bi === c(bf, "loading") || (a8.hasOwnProperty("worldquesttype") && a8.worldquesttype != 0) || (a8.hasOwnProperty("daily") && a8.daily != 0) || (a8.hasOwnProperty("weekly") && a8.weekly != 0)) {
                      aZ = false
                  }
              }
              var bk = !(aZ && (al in g_completion_categories) && WH.inArray(g_completion_categories[al], a8.completion_category) === -1);
              if (aZ) {
                  for (var bw in g_user.lists) {
                      ...
                      a2 += '<br><span class="progress-icon ' + (ba ? "progress-8" : "progress-0") + '"></span> ';
                      a2 += bu.character + " - " + bu.realm + " " + bu.region
                  }
              }
              if (a2 != "") {
                  bi += '<br><span class="q">' + window.LANG.completion + ":</span>" + a2
              }
          }
          if (!P && al == x && WH.isSet("g_completion") && ("bagscans" in g_completion) && WH.isRetailTree(U)) {
              var bb = /^\d+/.exec(F);
              if (bb) {
                  bb = bb[0]
              } else {
              ...
              while (bg = br.pop()) {
                  if (g_completion.bagscans[bg].items.hasOwnProperty(bb)) {
                      bn += '<tr><td class="q2" style="text-align: right">' + g_completion.bagscans[bg].items[bb] + '&nbsp;</td><td style="white-space: nowrap">' + g_completion.bagscans[bg].name + "</td></tr>"
                  }
              }
              if (bn != "") {
                  bi += '<br><span class="q">' + window.LANG.tooltip_bagscanner + "</span><br><table>" + bn + "</table>"
              }
          }
          if (!P && al == aN && typeof WH.getPreferredTransmogRace !== "undefined") {
              var a6 = WH.getPreferredTransmogRace();
              bi = bi.replace(/\/modelviewer(\/classic)?\/transmog\/\d+\/\d+\//g, "/modelviewer$1/transmog/" + a6.race + "/" + (a6.gender - 1) + "/")
          }
          ...
          var bm = function(bA, bz) {
              if (al !== bA.type || F !== bA.id || U !== bA.dataEnv || ay !== bA.locale || p !== bA.params) {
                  return
              }
              switch (ap) {
                  case aG.screen:
      ...
      function aM(aZ, a0, a2, a1) {
          switch (a1.type) {
              case aO:
                  var aY = $WowheadPower.getEntity(a1.type, a1.id, a1.dataEnv, a1.locale);
                  if (a1.params.spec && !(a1.params.know && a1.params.know.length)) {
                      ab.getSpellsBySpec(a1.params.spec, function(a3) {
                          aZ = aZ.replace(/<!--embed:([^>]+)-->/g, function(a4, a5) {
                              return WH.setTooltipSpells(aY.data.embeds[a5].tooltip, a3, aY.data.embeds[a5].spells)
                          });
                          a2(aZ)
                      });
                      break
                      ...
                      aZ = aZ.replace(/<!--embed:([^>]+)-->/g, function(a3, a4) {
                          return WH.setTooltipSpells(aY.data.embeds[a4].tooltip, a1.params.know, aY.data.embeds[a4].spells)
                      })
                  }
      ...
      function ar(aY, a0, aZ) {
          return a0 + (aZ.rand ? "r" + aZ.rand : "") + (aZ.ench ? "e" + aZ.ench : "") + (aZ.gems ? "g" + aZ.gems.join(",") : "") + (aZ.sock ? "s" : "") + (aZ.upgd ? "u" + aZ.upgd : "") + (aZ.twtbc ? "twtbc" : "") + (aZ.twwotlk ? "twwotlk" : "") + (aZ.twcata ? "twcata" : "") + (aZ.twmists ? "twmists" : "") + (aZ.ilvl ? "ilvl" + aZ.ilvl : "") + (aZ.lvl ? "lvl" + aZ.lvl : "") + (aZ.gem1lvl ? "g1lvl" + aZ.gem1lvl : "") + (aZ.gem2lvl ? "g2lvl" + aZ.gem2lvl : "") + (aZ.gem3lvl ? "g3lvl" + aZ.gem3lvl : "") + (aZ.artk ? "ak" + aZ.artk : "") + (aZ.nlc ? "nlc" + aZ.nlc : "") + (aZ.transmog ? "transmog" + aZ.transmog : "") + (aZ.tink ? "tink" + aZ.tink : "") + (aZ.pvp ? "pvp" : "") + (aZ.bonus ? "b" + aZ.bonus.join(",") : "") + (aZ.gem1bonus ? "g1b" + aZ.gem1bonus.join(",") : "") + (aZ.gem2bonus ? "g2b" + aZ.gem2bonus.join(",") : "") + (aZ.gem3bonus ? "g3b" + aZ.gem3bonus.join(",") : "") + (aZ.q ? "q" + aZ.q : "") + (aZ.level ? "level" + aZ.level : "") + (aZ.abil ? "abil" + aZ.abil.join(",") : "") + (aZ.dd ? "dd" + aZ.dd : "") + (aZ.ddsize ? "ddsize" + aZ.ddsize : "") + (aZ.diff == ai ? "diff" + aZ.diff : "") + (aZ.rank ? "rank" + aZ.rank : "") + (aY !== ai && aZ.spec ? "spec" + aZ.spec : "") + (aZ.rewards ? "rewards" + aZ.rewards.join(":") : "") + (aZ["azerite-powers"] ? "azPowers" + aZ["azerite-powers"] : "") + (aZ["azerite-essence-powers"] ? "aePowers" + aZ["azerite-essence-powers"] : "") + (aZ.nomajor ? "nomajor" : "")
      }
      ...
      this.register = function(a5, aZ, a0, a6, a4) {
          ...
          if (!ab.isLoaded(a5, a0)) {
              a3.status = y;
              ab.registerCallback(a5, a0, this.register.bind(this, a5, aZ, a0, a6, a4));
              return
          }
          if ((typeof aZ === "string" && (aZ.indexOf("lvl") === 0 || aZ.match(/[^i]lvl/))) && !ab.isLoaded(ai, a0)) {
              a3.status = y;
              ab.registerCallback(ai, a0, this.register.bind(this, a5, aZ, a0, a6, a4));
              return
          }
          if (a3.timer) {
          ...
          if (WH.Tooltip.showingTooltip && al == a5 && F == aZ && U == a0 && ay == a6) {
              ...
              aT(a6, a3.data[w()], a3.data.icon, a3.data.map, a3.data[aX()], a3.data[w(2)], a8, a9)
          }
      ...
      this.replaceWithTooltip = function(a8, a4, aZ, a0, a6, a1) {
          ...
          switch (a2.status) {
              ...
              case ag:
              case O:
                  a2.callbacks.push(this.replaceWithTooltip.bind(this, a8, a4, aZ, a0, a6, a1));
