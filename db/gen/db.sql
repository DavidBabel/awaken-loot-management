...
(true, 10, 'Enchantement', 'Casque', 'libram ou ZG'),
(true, 15, 'Enchantement', 'Epaulettes', 'exalté ZG ou +5 all resist'),
(true, 05, 'Enchantement', 'Cape', ''),
(true, 10, 'Enchantement', 'Plastron', ''),
(true, 10, 'Enchantement', 'Bracelet', ''),
(true, 10, 'Enchantement', 'Gants', ''),
(true, 10, 'Enchantement', 'Pantalon', 'libram ou ZG'),
(true, 10, 'Enchantement', 'Bottes', ''),

(true, 10, 'Enchantement', 'Arme droite', ''),
(true, 10, 'Enchantement', 'Arme gauche', 'automatique pour les armes 2 mains'),
(true, 05, 'Enchantement', 'Arme distance', ''),


(true, 10, 'Pré-raid', 'Casque', ''),
(true, 10, 'Pré-raid', 'Collier', ''),
(true, 10, 'Pré-raid', 'Epaulettes', ''),
(true, 10, 'Pré-raid', 'Cape', ''),
(true, 10, 'Pré-raid', 'Plastron', ''),
(true, 10, 'Pré-raid', 'Bracelet', ''),
(true, 10, 'Pré-raid', 'Gants', ''),
(true, 10, 'Pré-raid', 'Ceinture', ''),
(true, 10, 'Pré-raid', 'Pantalon', ''),
(true, 10, 'Pré-raid', 'Bottes', ''),
(true, 10, 'Pré-raid', 'Anneau 1', ''),
(true, 10, 'Pré-raid', 'Anneau 2', ''),
(true, 10, 'Pré-raid', 'Bijou 1', ''),
(true, 10, 'Pré-raid', 'Bijou 2', ''),

(true, 10, 'Pré-raid', 'Arme droite', ''),
(true, 10, 'Pré-raid', 'Arme gauche', 'automatique pour les armes 2 mains'),
(true, 10, 'Pré-raid', 'Arme distance / relique / totem', ''),


(true, 05, 'T1 / R10', 'Casque', ''),
(true, 05, 'T1 / R10', 'Collier', ''),
(true, 05, 'T1 / R10', 'Epaulettes', ''),
(true, 05, 'T1 / R10', 'Cape', ''),
(true, 05, 'T1 / R10', 'Plastron', ''),
(true, 05, 'T1 / R10', 'Bracelet', ''),
(true, 05, 'T1 / R10', 'Gants', ''),
(true, 05, 'T1 / R10', 'Ceinture', ''),
(true, 05, 'T1 / R10', 'Pantalon', ''),
(true, 05, 'T1 / R10', 'Bottes', ''),
(true, 05, 'T1 / R10', 'Anneau 1', ''),
(true, 05, 'T1 / R10', 'Anneau 2', ''),
(true, 05, 'T1 / R10', 'Bijou 1', ''),
(true, 05, 'T1 / R10', 'Bijou 2', ''),

(true, 05, 'T1 / R10', 'Arme droite', ''),
(true, 05, 'T1 / R10', 'Arme gauche', 'automatique pour les armes 2 mains'),
(true, 05, 'T1 / R10', 'Arme distance / relique / totem', ''),


(true, 05, 'T2 / R13', 'Casque', ''),
(true, 05, 'T2 / R13', 'Collier', ''),
(true, 05, 'T2 / R13', 'Epaulettes', ''),
(true, 05, 'T2 / R13', 'Cape', ''),
(true, 05, 'T2 / R13', 'Plastron', ''),
(true, 05, 'T2 / R13', 'Bracelet', ''),
(true, 05, 'T2 / R13', 'Gants', ''),
(true, 05, 'T2 / R13', 'Ceinture', ''),
(true, 05, 'T2 / R13', 'Pantalon', ''),
(true, 05, 'T2 / R13', 'Bottes', ''),
(true, 05, 'T2 / R13', 'Anneau 1', ''),
(true, 05, 'T2 / R13', 'Anneau 2', ''),
(true, 05, 'T2 / R13', 'Bijou 1', ''),
(true, 05, 'T2 / R13', 'Bijou 2', ''),

(true, 05, 'T2 / R13', 'Arme droite', ''),
(true, 05, 'T2 / R13', 'Arme gauche', 'automatique pour les armes 2 mains'),
(true, 05, 'T2 / R13', 'Arme distance / relique / totem', ''),
...
(true, 10, 'Spécialisation', 'Publiée sur le forum', ''),
...
(true, 05, 'Grade', 'Avoir le grade Maître de classe', 'également pour les Officier'),
(true, 05, 'Grade', 'Avoir le grade Vétéran', 'également pour les Maître de classe'),
...
(true, 03, 'Communauté', 'Avoir le même nom sur le forum qu‘en jeu', ''),
(true, 03, 'Communauté', 'Avoir un avatar sur le Discord', ''),
(true, 03, 'Communauté', 'Avoir le même nom sur le Discord qu‘en jeu', ''),
(true, 02, 'Communauté', 'Avoir un micro correctement configuré sur Discord', ''),

(true, 05, 'Communauté', 'Est un ancien Awaken (true, Nostalrius)', ''),
...
(true, 07, 'Farm Guilde', 'Est un artisant de la guilde', 'Dépeuceur 315 / TDC Spé / Couture / Forge / Enchantement'),
...
(true, 10, 'Raid', 'Grade PvP 6 : Garde de Pierre : Accès aux potions', ''),
(true, 10, 'Raid', 'Exalté Altérac (true, pré-raid épique)', ''),
