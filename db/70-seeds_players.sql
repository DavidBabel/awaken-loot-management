...
('Deiv'         , 1,  'officer', null, true),
('Krigen'       , 8,  'officer', null, true),
...
('Ragegoriath'  , 8,  'classMaster', null, true),
('Abramus'      , 2,  'classMaster', null, true),
('Shaheem'      , 3,  'player', null, false),
('Hakken'       , 2,  'player', null, false),
